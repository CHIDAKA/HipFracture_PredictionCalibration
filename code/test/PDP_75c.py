...
if __name__ == "__main__":
    ...
    for feature in features:
        ...
        for i in range(n_rep):
            model_path = f"./data/ratio_{ratio}/Model_{i}_x1_over75calib.pkl"
        ...
        pickle_path = f"./data/ratio_{ratio}/x1_over75calib_{feature}_pdp.pkl"
        ...
        for k in summary:
            ...
            plt.show()
            plt.savefig(f"./data/ratio_{ratio}/x1_over75calib_{k}_{feature}_pdp.pdf")
